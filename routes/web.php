...
Route::get('{user}/auto_parts/{accessory} ', 'AccessoriesController@showAutoParts')->name('accessories.autoPart');
...
Route::post('/feedback' ,'HomeController@saveFeedback')->middleware('auth');
...
Route::get('/admin/feedback', 'HomeController@getAllFeedback');
...
Route::get('/bike/delete/{bike}','BikeController@destroy');
Route::get('/accessory/delete/{accessory}','AccessoriesController@destroy');
Route::get('/fav/bike/delete/{bike}','FavAdsController@destroyBike');
Route::get('/fav/accessory/delete/{accessory}','FavAdsController@destroyAccessory');
Route::get('/admin/users', 'HomeController@getAllUsers')->name('admin_user');
Route::get('/admin_users/{user}/edit', 'HomeController@editUser');
Route::post('/admin_users/{user}', 'HomeController@updateUser');
