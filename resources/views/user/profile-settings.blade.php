                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12" style="border-bottom: 1px solid #ccc; margin-bottom: 30px">
                                ...
                                <div class="col-md-8">
                                    <ul class="pull-right">
                                        ...
                                        <li><a class="active" href="profile-settings.blade.php">Profile settings</a></li>
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12 col-md-offset-1 col-sm-offset-0 col-xs-offset-0 profile-setings">
                                <div class="card">
                                    <div class="col-md-4 col-sm-4 col-xs-12" style="padding: 15px;"><figure><img class="img-responsive" src="images/news2.jpg"> </figure></div>
                                    <div class="col-md-8 col-sm-8 col-xs-12" style="padding: 15px;">
                                        <label class="contact">Contact Name
                                            <input type="text" class="form-control" placeholder="Contact Name"></label>
                                        <label class="contact">Phone Number
                                            <input type="text" class="form-control" placeholder="Phone"></label>
                                        <label class="contact">Location
                                            <input type="text" class="form-control" placeholder="Location"></label>
                                        <p class="map"><a href="#"><i class="fa fa-map-marker"></i> Use My Location</a></p>
                                        <p><a href="#" class="btn btn-default">Save</a></p>
                                    </div>
