            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="border-bottom: 1px solid #ccc; margin-bottom: 30px">
                        <div class="col-md-4">
                            <h2><span><a href="/profile?ads=all"> View Profile</a></span></h2>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12" style="padding: 15px;">
                                    ...
                                    <label class="contact">Location
                                        <input type="text" class="form-control" name="city_area" value="{{ old('city_area', $user->city_area) }}" placeholder="Location"></label>
